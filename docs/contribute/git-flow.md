<!-- Space: Projects -->
<!-- Parent: ZshWtfutil -->
<!-- Title: Contributing GitFlow ZshWtfutil -->
<!-- Label: ZshWtfutil -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GitFlow -->
...
To contribute to zsh-wtfutil project on [GitHub](https://github.com/hadenlabs/zsh-wtfutil), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-wtfutil/pulls).

![workflow gitflow](https://datasift.github.io/gitflow/GitFlowHotfixBranch.png)

## Getting started

To follow the instructions in this guide and start contributing to zsh-wtfutil project on Gitlab:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-wtfutil.git
```

Now your **upstream** points to **hadenlabs/zsh-wtfutil**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-wtfutil
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-wtfutil/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
